...
| 能力域 | 仓库 | 主要内容 |
|---|---|---|
| 安全监测与威胁检测 | [security-monitoring](./repositories/security-monitoring) | 告警监测、日志分析、流量分析和检测规则 |
| 安全溯源与数字取证 | [threat-tracing-forensics](./repositories/threat-tracing-forensics) | 攻击源分析、终端溯源和数字取证 |
